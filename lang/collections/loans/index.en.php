...
*/
$LANG['HOME'] = 'Home';
$LANG['LOAN'] = 'Loan Management Main Menu';
$LANG['COLL'] = 'Collection Management Menu';
$LANG['OUT'] = 'Outgoing Loans';
$LANG['INCO'] = 'Incoming Loans';
$LANG['GIFT'] = 'Gifts/Exchanges';
$LANG['OPTION'] = 'Options';
$LANG['SEARCH'] = 'Search:';
$LANG['DISPLAY'] = 'Display outstanding loans only';
$LANG['DIS'] = 'Display all loans';
$LANG['NEW'] = 'New Outgoing Loan';
$LANG['ENTER'] = 'Entered By:';
$LANG['LOAN_IDEN'] = 'Loan Identifier:';
$LANG['SEND'] = 'Send to Institution:';
$LANG['SELEC'] = 'Select Institution';
$LANG['CREA'] = 'Create Loan';
$LANG['OP'] = 'Options';
$LANG['SEAR'] = 'Search:';
$LANG['DI'] = 'Display outstanding loans only';
$LANG['DIS_ALL'] = 'Display all loans';
$LANG['NEW_INCOM'] = 'New Incoming Loan';
$LANG['ENTER_BY'] = 'Entered By:';
$LANG['LOAN_INDENTIFIER'] = 'Loan Identifier:';
$LANG['SENT'] = 'Sent From:';
