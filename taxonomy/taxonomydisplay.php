		...
		<div>
			<form id="tdform" name="tdform" action="taxonomydisplay.php" method='POST'>
				<fieldset style="padding:10px;width:550px;">
					<legend><b><legend><b><?php echo $LANG['ENTER_SPECIES']; ?></b></legend>
					<div>
					...
					<div style="margin:15px 15px 0px 60px;">
						<input name="displayauthor" type="checkbox" value="1" <?php echo ($displayAuthor?'checked':''); ?> /> <?php echo $LANG['VIEW_AUTHORS']; ?>
					</div>
					<div style="margin:3px 15px 0px 60px;">
						<input name="displayfulltree" type="checkbox" value="1" <?php echo ($displayFullTree?'checked':''); ?> /> <?php echo $LANG['SHOW']; ?>
					</div>
					<div style="margin:3px 15px 15px 60px;">
						<input name="displaysubgenera" type="checkbox" value="1" <?php echo ($displaySubGenera?'checked':''); ?> /> <?php echo $LANG['VISUALEZE']; ?>
					</div>
				</fieldset>
			</form>
		</div>
